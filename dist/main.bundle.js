...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__component_js__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__navbar_js__ = __webpack_require__(332);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__board_js__ = __webpack_require__(333);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__deck_js__ = __webpack_require__(334);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__reset_js__ = __webpack_require__(339);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__main_css__ = __webpack_require__(340);
...
var Main = function (_Component) {
  ...
  function Main(root) {
    ...
    _this.mode = ['easy', 'hard', 'nightmare'];

    _this.navbar = new __WEBPACK_IMPORTED_MODULE_1__navbar_js__["a" /* default */](root.querySelector('.navbar'));
    _this.navbar.on('click', _this.handleModeClick.bind(_this));

    // just show message

    _this.deck = new __WEBPACK_IMPORTED_MODULE_3__deck_js__["a" /* default */](root.querySelector('.deck'));
    _this.deck.on('rightClick', _this.handleRightClick.bind(_this));
    _this.deck.on('wrongClick', _this.handleWrongClick.bind(_this));

    _this.board = new __WEBPACK_IMPORTED_MODULE_2__board_js__["a" /* default */](root.querySelector('.board'), _this.deck.getPickedColor());
    _this.board.on('timeOut', _this.setTimeOut.bind(_this));
    _this.board.on('blink', _this.handleBlink.bind(_this));
  ...
  _createClass(Main, [{
    key: 'setTimeOut',
    value: function setTimeOut(firer) {
    ...
    key: 'handleModeClick',
    value: function handleModeClick(firer, activeMode) {
      this.activeMode = activeMode;
      this.deck.selectedMode(activeMode);
      this.handleResetClick();
    }
  }, {
    key: 'handleNightmareMode',
    value: function handleNightmareMode() {
      var _this2 = this;
    ...
    value: function handleRightClick(firer, color) {
    ...
    key: 'handleWrongClick',
    value: function handleWrongClick(firer) {
...
var Navbar = function (_Component) {
    ...
    function Navbar(root) {
        ...
        _this.pickMode = 'easy';
        _this.modes = [];
        var els = root.querySelectorAll('.mode');
        ...
        try {
            for (var _iterator = els[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                ...
                var mode = i.textContent.toLowerCase();
                i.addEventListener('click', _this.handleDomClick.bind(_this, i, mode));
                _this.modes.push(i);
            }
        } catch (err) {
    ...
    _createClass(Navbar, [{
        key: 'handleDomClick',
        value: function handleDomClick(a, mode) {
            this.pickMode = mode;
            this.removeActive();
        ...
        value: function removeActive() {
            ...
            try {
                for (var _iterator2 = this.modes[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                    var i = _step2.value;
...
var Board = function (_Component) {
    ...
    function Board(root, color) {
        ...
        _this.timerDisplay = root.querySelector('#countDown');
    ...
    _createClass(Board, [{
        ...
        key: 'showTimerMessage',
        value: function showTimerMessage() {
            this.timerDisplay.textContent = 'COUNT DOWN IN ' + this.setTimer + ' SEC';
        }
    }, {
        key: 'hideTimerMessage',
        value: function hideTimerMessage() {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__component_js__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__card_js__ = __webpack_require__(335);
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var Deck = function (_Component) {
    ...
    _createClass(Deck, [{
        ...
        key: 'buildCards',
        value: function buildCards(root) {

            var els = root.querySelectorAll('.card');
            ...
            try {
                for (var _iterator = els[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                    ...
                    var card = new __WEBPACK_IMPORTED_MODULE_1__card_js__["a" /* default */](i);
        ...
        key: 'selectedMode',
        value: function selectedMode(mode) {
            this.mode = mode;
        }
    }, {
        key: 'handleCardClick',
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__component_js__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__card_css__ = __webpack_require__(336);
